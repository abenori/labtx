...
ams_styles.Template.Templates["article"] = U"[$<author>:$<title>:<|$<journal>|< \\textbf{|$<volume>|}>< (|$<year>|)>>:<no.~|$<number>|>:$<pages>:@S<>< (|$<language>|)>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["book"] = U"[$<author|editor>:$<title>:$<edition>:$<book_volume_series_number>:$<publisher>:$<address>:$<date>:@S<>< (|$<language>|)>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["booklet"] = U"[$<author>:$<title>:$<howpublished>:$<address>:$<date>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["inbook"] = U"[$<author|editor>:$<title>:$<edition>:$<book_volume_series_number>:$<chapter_pages>:$<publisher>:$<address>:$<date>:@S<>$< (|$<language>|)>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["incollection"] = U"[$<author>:$<title>:$<incollection_title_editor>:$<book_volume_series_number>:$<publisher>:$<address>:$<edition>:$<date>:$<note>:$<book_pages>:@S<>< (|$<language>|)>]$<mrnumfunc>"
ams_styles.Template.Templates["inproceedings"] = U"[$<author>:$<title>:<|$<booktitle>|< (|$<address>|)>< |$<editor_nonauthor>|>>:$<book_volume_series_number>:$<organization>:$<publisher>:$<date>:$<note>:$<book_pages>:@S<>< (|$<language>|)>]$<mrnumfunc>"
ams_styles.Template.Templates["conference"] = ams_styles.Template.Templates[U"inproceedings"]
ams_styles.Template.Templates["manual"] = U"[$<author|organization_address>:$<title>:$<manual_organization_address_aftertittle>:$<edition>:$<date>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["mastersthesis"] = U"[$<author>:$<title>:$<master_thesis_type>:$<school>:$<address>:$<date>:$<note>:$<book_pages>]$<mrnumfunc>"
ams_styles.Template.Templates["misc"] = U"[$<author>:$<title>:$<howpublished>:$<date>:$<note>:$<book_pages>]$<mrnumfunc>"
ams_styles.Template.Templates["phdthesis"] = U"[$<author>:$<title>:$<phd_thesis_type>:$<school>:$<address>:$<date>:$<note>:$<book_pages>]$<mrnumfunc>"
ams_styles.Template.Templates["proceedings"] = U"[$<editor|organization>:$<title>:$<book_volume_series_number>:$<address>:$<proceedings_organization>:$<publisher>:$<date>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["techreport"] = U"[$<author>:$<title>:$<tech_rep_number>:$<institution>:$<address>:$<date>:$<note>]$<mrnumfunc>"
ams_styles.Template.Templates["unpublished"] = U"[$<author>:$<title>:$<note>:$<date>]$<mrnumfunc>"
...
ams_styles.Template.Formatter.date = U"<<|$<month>| >|$<year>|>"
...
ams_styles.Template.Formatter.mrnumfunc = U"<\\MR{|$<mrnumber>|}>"

ams_styles.Template.blockseparator = {U", "}
ams_styles.Template.blocklast = {U". "}
